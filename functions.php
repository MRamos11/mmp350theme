...
function demo_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'demo' ),
	) );
...
// ========================================================
 ...
 function customFooter($count){
 	for ($i=0; $i <$count ; $i++) { 
 		echo 'Footer and More Footer';
 	}
 }

 function customSidebar(){
 	for ($i=0; $i <10 ; $i++) { 
 		echo ' Sidebar and More Sidebar ' ;
 	}
 }
...
function demo_scripts() {
	...
	wp_enqueue_script( 'demo-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'demo-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
